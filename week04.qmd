...
Sequence looks as if it might allow floating point value. 1:6 integer only
...
- What happens when you mix integers and doubles in a vector? Coercion according to Rs rules
- What does the `L` suffix do? Makes it an integer
...
glue::glue("This unit is great.
           Do you agree?")
gtext <- glue::glue("This unit is great. Do you agree?")
typeof(gtext)
```
...
*Write your analysis here:* They are different. Paste seems like concatenate in other languages
...
1 cannot be a variable and <- requires a variable on LHS
- What's the difference between `=` and `==`?

*Write your explanation here:*
= assigns == compares and reyruns T/F
...
*Write your thoughts here:*
I worked thru the boof section. Mr Grolemind.
...
By default it reads the values as if they are column_vector1, column_cevtor_2 , ...
ByRows = TRUE makes it read the flat vector as if it is one row vector followed by another
...
*Write your thoughts here:*
Use tribble to input a smallish grid in a nice order to read and write
...
*Write your thoughts here:*
my_weather_data.csv was created in the ./data folder
...
cholesterol_tidy <- cholesterol_data |> pivot_longer(cols = c("oat_bran_free", "oat_bran")
                                 ,names_to = "diet"
